...
// DataForSEO "Labs – Keyword Ideas Live" — ~$0.01 pro Request
const DATAFORSEO_KEYWORD_IDEAS_USD = 0.01;
...
export async function recordDataForSeoKeywordIdeas(): Promise<void> {
  await dbRecordUsage("dataforseo", "keyword_ideas", 1, DATAFORSEO_KEYWORD_IDEAS_USD * USD_TO_EUR);
}
